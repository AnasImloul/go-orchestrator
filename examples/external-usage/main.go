...
func main() {
	...
	_ = slogLogger // Logger will be used in the orchestrator
	...
	// Create orchestrator
	orch, err := orchestrator.NewWithConfig(config)
	if err != nil {
...
func (f *DatabaseFeature) RegisterServices(container orchestrator.Container) error {
	...
	return container.RegisterSingleton(
		...
		func(ctx context.Context, c orchestrator.Container) (interface{}, error) {
...
func (f *DatabaseFeature) CreateComponent(container orchestrator.Container) (orchestrator.Component, error) {
	return &DatabaseComponent{name: f.name}, nil
}

func (f *DatabaseFeature) GetRetryConfig() *orchestrator.RetryConfig {
...
func (c *DatabaseComponent) Health(ctx context.Context) orchestrator.ComponentHealth {
...
func (c *DatabaseComponent) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (f *CacheFeature) RegisterServices(container orchestrator.Container) error {
	fmt.Printf("🔧 Registering cache services for %s\n", f.name)
	return nil
}

func (f *CacheFeature) CreateComponent(container orchestrator.Container) (orchestrator.Component, error) {
	return &CacheComponent{name: f.name}, nil
}

func (f *CacheFeature) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (c *CacheComponent) Health(ctx context.Context) orchestrator.ComponentHealth {
	return orchestrator.ComponentHealth{
		Status:    "healthy",
...
func (c *CacheComponent) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (f *APIFeature) RegisterServices(container orchestrator.Container) error {
	fmt.Printf("🔧 Registering API services for %s\n", f.name)
	return nil
}

func (f *APIFeature) CreateComponent(container orchestrator.Container) (orchestrator.Component, error) {
	return &APIComponent{name: f.name}, nil
}

func (f *APIFeature) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (c *APIComponent) Health(ctx context.Context) orchestrator.ComponentHealth {
	return orchestrator.ComponentHealth{
		Status:    "healthy",
...
func (c *APIComponent) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (f *WorkerFeature) RegisterServices(container orchestrator.Container) error {
	fmt.Printf("🔧 Registering worker services for %s\n", f.name)
	return nil
}

func (f *WorkerFeature) CreateComponent(container orchestrator.Container) (orchestrator.Component, error) {
	return &WorkerComponent{name: f.name}, nil
}

func (f *WorkerFeature) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}
...
func (c *WorkerComponent) Health(ctx context.Context) orchestrator.ComponentHealth {
	return orchestrator.ComponentHealth{
		Status:    "healthy",
...
func (c *WorkerComponent) GetRetryConfig() *orchestrator.RetryConfig {
	return nil
}